      ...
      <Layout>
        ...
        <MuiContainer style={{ textAlign: 'center', alignItems: 'center' }} maxWidth="lg">
          ...
          <Grid container spacing={2} alignItems='center' alignContent='center' maxWidth="lg" flexWrap="wrap" direction="column" >
            ...
            <Grid>
              <Typography variant='body1'>I recently took a full time position, so I'm no longer looking for opportunities. I'm still open for part time freelance work though, so drop me a line at</Typography>
            </Grid>
            <Grid>
